...
<!-- ====================================================================== -->
<!-- showdown library version 1.9.1 (it needs some polyfills)               -->
<!--                                                                        -->
<!-- https://github.com/showdownjs/showdown                                 -->
<!-- https://github.com/showdownjs/showdown/wiki/Showdown's-Markdown-syntax -->
<!-- https://cdnjs.cloudflare.com/ajax/libs/showdown/1.9.1/showdown.js      -->
<!-- ====================================================================== -->
...
(function(){
  ...
  showdown.subParser('ellipsis', function (text, options, globals) {
    ...
    //text = text.replace(/\.\.\./g, '?'); // <-- REMUS it does show ? in output
