...
<!-- =================================================== -->
<!-- File    : REM_PFC_Spanish_Strings.xsl               -->
...
<!-- Definición de cadenas para Español    -->
...
<!-- Esta son específicas para PFC -->
<xsl:variable name="rem:lang_docente">[Docente]</xsl:variable>
<xsl:variable name="rem:lang_tecnico">[Técnico]</xsl:variable>
<xsl:variable name="rem:lang_parte">[Parte]</xsl:variable>
<xsl:variable name="rem:lang_biblio">[Biblio]</xsl:variable>

<!-- Estas son las mismas que para la plantilla por defecto -->    
...
<xsl:variable name="rem:lang_project">Proyecto Fin de Carrera</xsl:variable>
...
<xsl:variable name="rem:lang_irq_lp_01">
    El sistema deberá almacenar la información correspondiente a 
</xsl:variable>
...
<xsl:variable name="rem:lang_crq_lp_01">
	El sistema deberá respetar la siguiente regla de negocio o restricción: 
</xsl:variable>
...
<xsl:variable name="rem:lang_uc_lp_02">
    caso de uso abstracto durante la realización de los siguientes casos de uso: 
</xsl:variable>
...
<xsl:variable name="rem:lang_uc_lp_04">
    o durante la realización de los siguientes casos de uso:
</xsl:variable>
